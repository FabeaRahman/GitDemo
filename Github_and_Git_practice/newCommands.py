...
# again check the branche and create a new feature branch
# change something then add commit and push it
# after creating you have to pull the request in github where you will see a option (ompare and pull request)
